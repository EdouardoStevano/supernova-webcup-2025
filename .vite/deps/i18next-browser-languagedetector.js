...
var sessionStorage = {
    ...
    lookup(_ref) {
        ...
        if (lookupSessionStorage && sessionStorageAvailable()) {
            return (
                window.sessionStorage.getItem(lookupSessionStorage) || void 0
            );
        }
        return void 0;
    },
...
var subdomain = {
    ...
    lookup(_ref) {
        ...
        const language =
            ...
            ((_b = (_a = window.location) == null ? void 0 : _a.hostname) ==
            null
                ? void 0
                : _b.match(
...
var Browser = class {
    ...
    detect() {
        ...
        detected = detected
            .filter((d) => d !== void 0 && d !== null && !hasXSS(d))
