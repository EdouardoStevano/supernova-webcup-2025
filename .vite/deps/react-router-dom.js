...
function getMatchesToLoad(
    ...
    let baseShouldRevalidateArgs = {
        currentUrl,
        currentParams:
            ((_a = state.matches[0]) == null ? void 0 : _a.params) || {},
        nextUrl,
                ...
                while (Object.keys(encoder2.deferred).length > 0) {
                    for (const [deferredId, deferred] of Object.entries(
                        ...
                        seenPromises.add(
                            ...
                            (encoder2.deferred[Number(deferredId)] =
...
function useFogOFWarDiscovery(
    ...
    React8.useEffect(() => {
        ...
        if (
            ...
            ((_b = (_a = window.navigator) == null ? void 0 : _a.connection) ==
            null
                ? void 0
                : _b.saveData) === true
        ) {
        ...
        if (url.pathname.endsWith('.data')) {
            ...
            if (_build.unstable_getCriticalCss) {
                ...
                criticalCss = await ((_c =
                    (_b = getDevServerHooks()) == null
                        ? void 0
                        : _b.getCriticalCss) == null
                    ? void 0
                    : _c.call(_b, pathname));
            }
...
function createHydratedRouter({ unstable_getContext }) {
    ...
    if (ssrInfo.context.isSpaMode) {
        ...
        if (
            ((_a = ssrInfo.manifest.routes.root) == null
                ? void 0
                : _a.hasLoader) &&
            loaderData &&
            'root' in loaderData
