'use client';
import { require_jsx_runtime } from './chunk-J3GJSMK3.js';
    ...
    const generator = {
        ...
        toString: () => {
            ...
            const easing = generateLinearEasing(
                (progress2) =>
                    generator.next(calculatedDuration * progress2).value,
                calculatedDuration,
                30
            );
...
function createMixers(output, ease2, customMixer) {
    ...
    for (let i = 0; i < numMixers; i++) {
        ...
        if (ease2) {
            const easingFunction = Array.isArray(ease2)
                ? ease2[i] || noop
                : ease2;
...
var KeyframeResolver = class {
    ...
    readKeyframes() {
        ...
        if (unresolvedKeyframes[0] === null) {
            const currentValue =
                motionValue2 == null ? void 0 : motionValue2.get();
            const finalKeyframe =
...
var NativeAnimation = class extends WithPromise {
    ...
    commitStyles() {
        ...
        if (!this.isPseudoElement) {
            (_b = (_a = this.animation).commitStyles) == null
                ? void 0
                : _b.call(_a);
        }
    }
...
var AsyncMotionValueAnimation = class extends WithPromise {
    constructor({
        ...
        const KeyframeResolver$1 =
            (element == null ? void 0 : element.KeyframeResolver) ||
            KeyframeResolver;
        ...
        if (!canAnimate(keyframes2, name, type, velocity)) {
            if (MotionGlobalConfig.instantAnimations || !delay2) {
                onUpdate == null
                    ? void 0
                    : onUpdate(
                          getFinalKeyframe(keyframes2, options, finalKeyframe)
                      );
            }
    ...
    constructor(init, options = {}) {
        ...
        this.updateAndNotify = (v, render = true) => {
            ...
            if (this.current !== this.prev) {
                (_a = this.events.change) == null
                    ? void 0
                    : _a.notify(this.current);
                if (this.dependents) {
...
function processQueue() {
    ...
    if (
        !current ||
        ((_a = builders[0]) == null ? void 0 : _a.options.interrupt) ===
            'immediate'
    ) {
        next();
    }
...
var AnimatePresence = ({
    ...
    import_react10.useState)(presentChildren);
        ...
        children: renderedChildren.map((child) => {
            ...
            return (0, import_jsx_runtime3.jsx)(
                PresenceChild,
                {
                    isPresent: isPresent2,
                    initial:
                        !isInitialRender.current || initial ? void 0 : false,
                    custom,
                    presenceAffectsLayout,
                    mode,
...
var LayoutGroup = ({ children, id: id4, inherit = true }) => {
    const layoutGroupContext = (0, import_react14.useContext)(
        LayoutGroupContext
    );
...
function LazyMotion({ children, features, strict = false }) {
    const [, setIsLoaded] = (0, import_react16.useState)(
...
function getCurrentTreeVariants(props, context) {
    if (isControllingVariants(props)) {
        ...
        return {
            initial:
                initial === false || isVariantLabel(initial) ? initial : void 0,
...
function scrapeMotionValuesFromProps(props, prevProps, visualElement) {
    ...
    for (const key in style2) {
        if (
            ...
            ((_a =
                visualElement == null ? void 0 : visualElement.getValue(key)) ==
            null
                ? void 0
                : _a.liveStyle) !== void 0
        ) {
...
var ExitAnimationFeature = class extends Feature {
    ...
    update() {
        ...
        const { isPresent: isPresent2, onExitComplete } =
...
function MeasureLayout(props) {
    ...
    return (0, import_jsx_runtime8.jsx)(MeasureLayoutWithContext, {
        ...props,
        layoutGroup,
        switchLayoutGroup: (0, import_react28.useContext)(
            SwitchLayoutGroupContext
        ),
        isPresent: isPresent2,
        safeToRemove,
    ...
    for (let i = 0; i < numBorders; i++) {
        ...
        if (canMix) {
            target[borderLabel] = Math.max(
                mixNumber(
                    asNumber2(followRadius),
                    asNumber2(leadRadius),
                    progress2
                ),
                0
            );
    ...
    return class ProjectionNode {
        ...
        setOptions(options) {
            this.options = {
                ...
                ...options,
                crossfade:
                    options.crossfade !== void 0 ? options.crossfade : true,
            };
        }
        clearMeasurements() {
            this.scroll = void 0;
        ...
        scheduleRender(notifyAll2 = true) {
            var _a;
            (_a = this.options.visualElement) == null
                ? void 0
                : _a.scheduleRender();
            if (notifyAll2) {
                const stack = this.getStack();
        ...
        startAnimation(options) {
            ...
            (_c =
                (_b = this.resumingFrom) == null
                    ? void 0
                    : _b.currentAnimation) == null
                ? void 0
                : _c.stop(false);
        ...
        resetTree() {
            this.root.nodes.forEach((node) => {
                var _a;
                return (_a = node.currentAnimation) == null
                    ? void 0
                    : _a.stop(false);
            });
...
function notifyLayoutUpdate(node) {
    var _a;
    const snapshot =
        ((_a = node.resumeFrom) == null ? void 0 : _a.snapshot) ||
        node.snapshot;
    if (
        node.isLead() &&
        node.layout &&
        ...
        if (isMotionValue(nextValue)) {
            ...
            if (element.hasValue(key)) {
                ...
                element.addValue(
                    key,
                    motionValue(
                        latestValue !== void 0 ? latestValue : nextValue,
                        { owner: element }
                    )
                );
            }
    ...
    useLifecycleEffect(() => {
        ...
        return scroll(
            ...
            },
            {
                ...options,
                container:
                    (container == null ? void 0 : container.current) || void 0,
...
function useReducedMotionConfig() {
    ...
    const { reducedMotion } = (0, import_react37.useContext)(
        MotionConfigContext
    );
...
function animateSequence(sequence, options, scope) {
    ...
    animationDefinitions.forEach(
        ({ keyframes: keyframes2, transition }, subject) => {
            animations2.push(
                ...animateSubject(subject, keyframes2, transition)
            );
        }
    );
    return animations2;
    ...
    if (!readyAnimation) {
        ...
        window.MotionCheckAppearSync = (visualElement, valueName, value) => {
            ...
            const externalAnimationValue =
                (_b = visualElement.props.values) == null
                    ? void 0
                    : _b[valueName];
