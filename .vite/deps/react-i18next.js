...
function n(n2) {
    ...
    if (
        i2 &&
        ((r2.name = i2[1]),
        (import_void_elements.default[i2[1]] ||
            '/' === n2.charAt(n2.length - 2)) &&
            (r2.voidElement = true),
        r2.name.startsWith('!--'))
    ) {
        var s2 = n2.indexOf('-->');
...
function Trans({
    ...
    const interpolationOverride =
        values ||
        (count !== void 0 &&
            !((_f = (_e = i18n.options) == null ? void 0 : _e.interpolation) ==
            null
                ? void 0
                : _f.alwaysFormat)) ||
        !children
...
var getInitialProps = () => {
    ...
    const i18n = getI18n();
    const namespaces =
        ((_a = i18n.reportNamespaces) == null
            ? void 0
            : _a.getUsedNamespaces()) ?? [];
    const ret = {};
        ...
        return () => {
            ...
            if (i18n)
                bindI18n == null
                    ...
                    : bindI18n
                          .split(' ')
                          .forEach((e2) => i18n.off(e2, boundReset));
