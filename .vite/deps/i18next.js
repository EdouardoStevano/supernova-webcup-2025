...
var Translator = class _Translator extends EventEmitter {
    ...
    translate(keys, o, lastKey) {
        ...
        const resUsedKey =
            (resolved == null ? void 0 : resolved.usedKey) || key;
        ...
        if (
            ...
            if (keySeparator) {
                ...
                for (const m in resForObjHndl) {
                    if (
                        Object.prototype.hasOwnProperty.call(resForObjHndl, m)
                    ) {
    ...
    extendTranslation(res, key, opt, resolved, lastKey) {
        ...
        if ((_a = this.i18nFormat) == null ? void 0 : _a.parse) {
            ...
            const skipOnVariables =
                isString(res) &&
                (((_b = opt == null ? void 0 : opt.interpolation) == null
                    ? void 0
            ...
            let data =
                opt.replace && !isString(opt.replace) ? opt.replace : opt;
        ...
        keys.forEach((k) => {
            ...
            namespaces.forEach((ns) => {
                ...
                if (
                    ...
                    ((_a = this.utils) == null
                        ? void 0
                        : _a.hasLoadedNamespace) &&
                    !((_b = this.utils) == null
                        ? void 0
                        : _b.hasLoadedNamespace(usedNS))
                ) {
    ...
    getUsedParamsDetails(options2 = {}) {
        ...
        const useOptionsReplaceForData =
            options2.replace && !isString(options2.replace);
...
var PluralResolver = class {
    ...
    needsPlural(code, options2 = {}) {
        ...
        return (
            (rule == null
                ? void 0
                : rule.resolvedOptions().pluralCategories.length) > 1
        );
    }
    getPluralFormsOfKey(code, key, options2 = {}) {
        return this.getSuffixes(code, options2).map(
            (suffix) => `${key}${suffix}`
        );
    }
...
var Interpolator = class {
    ...
    resetRegExp() {
        const getOrResetRegExp = (existingRegExp, pattern) => {
            if (
                (existingRegExp == null ? void 0 : existingRegExp.source) ===
                pattern
            ) {
    ...
    interpolate(str, data, lng, options2) {
        ...
        const missingInterpolationHandler =
            (options2 == null
                ? void 0
                : options2.missingInterpolationHandler) ||
    ...
    nest(str, fc, options2 = {}) {
        ...
        const handleHasOptions = (key, inheritedOptions) => {
            ...
            if (
                (((matchedSingleQuotes == null
                    ? void 0
                    : matchedSingleQuotes.length) ?? 0) %
                    2 ===
                    0 &&
                    !matchedDoubleQuotes) ||
...
var Connector = class extends EventEmitter {
    constructor(backend, store, services, options2 = {}) {
        ...
        this.retryTimeout =
            options2.retryTimeout >= 1 ? options2.retryTimeout : 350;
        this.state = {};
        this.queue = [];
...
var transformOptions = (options2) => {
    ...
    if (
        ((_b = (_a = options2.supportedLngs) == null ? void 0 : _a.indexOf) ==
        null
            ? void 0
            : _b.call(_a, 'cimode')) < 0
    ) {
...
var I18n = class _I18n extends EventEmitter {
    ...
    loadResources(language, callback = noop) {
        ...
        if (!this.options.resources || this.options.partialBundledLanguages) {
            if (
                (usedLng == null ? void 0 : usedLng.toLowerCase()) ===
                    'cimode' &&
            ...
            (_b = (_a = this.options.preload) == null ? void 0 : _a.forEach) ==
            null
                ? void 0
    ...
    getFixedT(lng, ns, keyPrefix) {
        const fixedT = (key, opts, ...rest) => {
            ...
            if (o.keyPrefix && Array.isArray(key)) {
                ...
                resultKey = o.keyPrefix
                    ? `${o.keyPrefix}${keySeparator}${key}`
                    : key;
            }
