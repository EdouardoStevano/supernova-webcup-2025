...
function r(t2, e2) {
    return (
        (e2 = String.fromCharCode.apply(null, e2)), null == t2 ? e2 : t2 + e2
    );
}
var i;
var s;
...
function g(t2) {
    return (
        !!l &&
        !!u &&
        u.brands.some(({ brand: e2 }) => e2 && -1 != e2.indexOf(t2))
    );
}
function m(e2) {
    var n2;
...
function _() {
    return y()
        ? g('Chromium')
        : ((m('Chrome') || m('CriOS')) && !(!y() && m('Edge'))) || m('Silk');
}
function v(t2) {
    return v[' '](t2), t2;
}
...
function U(t2) {
    ...
    var e2 = t2.ba;
    return null ==
        (e2 = null == e2 || I(e2) ? e2 : 'string' == typeof e2 ? M(e2) : null)
        ? e2
        : (t2.ba = e2);
}
var D = class {
    ...
    next() {
        if (this.l < this.g.length) {
            ...
            return {
                ...
                value: this.h ? this.h.call(this.m, t2) : t2,
            };
        }
...
var kt = Et((t2) =>
    bt ? t2 >= xt && t2 <= Rt : '-' === t2[0] ? Ft(t2, St) : Ft(t2, Lt)
);
...
function Vt(t2) {
    if (t2.length < 16) Nt(Number(t2));
        ...
        (t2 = BigInt(t2)),
            (Pt = Number(t2 & BigInt(4294967295)) >>> 0),
            (Ot = Number((t2 >> BigInt(32)) & BigInt(4294967295)));
    else {
        const e2 = +('-' === t2[0]);
        Ot = Pt = 0;
        const n2 = t2.length;
        for (
            let r2 = e2, i2 = ((n2 - e2) % 6) + e2;
            i2 <= n2;
            r2 = i2, i2 += 6
        ) {
...
function qt(t2) {
    return (
        '-' !== t2[0] &&
        (t2.length < 20 ||
            (20 === t2.length && Number(t2.substring(0, 6)) < 184467))
    );
}
function Jt(t2) {
    return (
        (t2 = Math.trunc(t2)),
        Number.isSafeInteger(t2) || (Nt(t2), (t2 = Bt(Pt, Ot))),
        t2
    );
}
function Zt(t2) {
    ...
    if (
        ...
        !('-' === t2[0]
            ? t2.length < 20 ||
              (20 === t2.length && Number(t2.substring(0, 7)) > -922337)
            : t2.length < 19 ||
              (19 === t2.length && Number(t2.substring(0, 6)) < 922337)))
    )
...
function Qt(t2) {
    return null == t2
        ...
        : 'bigint' == typeof t2
          ? (kt(t2)
                ? (t2 = Number(t2))
                : ((t2 = BigInt.asIntN(64, t2)),
                  (t2 = kt(t2) ? Number(t2) : String(t2))),
            t2)
          : Kt(t2)
            ? 'number' == typeof t2
                ? Jt(t2)
...
function te(t2) {
    ...
    if (Kt(t2)) {
        if ('string' === e2)
            return (
                (e2 = Math.trunc(Number(t2))),
                Number.isSafeInteger(e2) && e2 >= 0
                    ? (t2 = String(e2))
                    : (-1 !== (e2 = t2.indexOf('.')) &&
                          (t2 = t2.substring(0, e2)),
                      qt(t2) || (Vt(t2), (t2 = Gt(Pt, Ot)))),
                t2
            );
        if ('number' === e2)
            return (t2 = Math.trunc(t2)) >= 0 && Number.isSafeInteger(t2)
                ? t2
                : (function (t3) {
                      if (t3 < 0) {
                          Nt(t3);
...
function se(t2, e2, n2) {
    ...
    return 'string' ==
        typeof (n2 = null == (t2 = e2) ? (n2 ? 0 : void 0) : t2) &&
        ((e2 = +n2), Number.isSafeInteger(e2))
        ? e2
        : n2;
}
function oe(t2) {
    if (
        (void 0 === ce && (ce = 'function' == typeof Proxy ? ye(Proxy) : null),
        !ce || !me())
    )
        return t2;
        ...
        (Math.random() > 0.01
            ...
            : ((function (t3) {
                  ...
                  le &&
                      ...
                      (t3[Symbol.isConcatSpreadable] = true);
              })(t2),
              (e2 = new ce(t2, {
                  set: (t3, e3, n2) => (j(), (t3[e3] = n2), true),
              })),
              (function (t3, e3) {
                  (ae || (ae = new ue())).set(t3, e3),
                      (he || (he = new ue())).set(e3, t3);
              })(t2, e2),
              e2))
    );
}
...
function _e(t2, e2, n2) {
    ...
    if (f && me()) {
        if (
            (_a2 = fe == null ? void 0 : fe.get(e2)) == null
                ? void 0
                : _a2.get(t2)
        ) {
            if (n2) return;
        ...
        for (var i2 = 0; i2 < Math.min(r2, 10); i2++) {
            if (r2 <= 10) var s2 = i2;
                ...
                s2 =
                    t3 +
                    Math.floor(
                        Math.random() * (Math.floor((i2 + 1) * s2) - t3)
                    );
            }
            n2[s2] = t2[s2];
        }
        Ee(t2, n2)
            ? ((i2 = (r2 = fe || (fe = new ue())).get(e2)) ||
                  ((i2 = new ue()), r2.set(e2, i2)),
              i2.set(t2, n2))
            : (j(), Te(t2, e2));
    }
}
function ve(t2, e2) {
    var _a2;
    const n2 =
        (_a2 = fe == null ? void 0 : fe.get(e2)) == null ? void 0 : _a2.get(t2);
...
function Ee(t2, e2) {
    ...
    for (const i2 in e2) {
        var n2,
            r2 = Number(i2);
        if (
            ((n2 = Number.isInteger(r2)) &&
                ((n2 = t2[r2]),
                (r2 = e2[r2]),
                (n2 = !(Number.isNaN(n2) ? Number.isNaN(r2) : n2 === r2))),
            n2)
        )
            return false;
    }
...
var Me = class extends Le {
    constructor(t2, e2, n2 = Re, r2 = Re) {
        ...
        for (let s2 = 0; s2 < t2.length; s2++) {
            ...
            e2
                ? void 0 === h2 && (h2 = null)
                : (h2 = r2(o2[1], false, true, void 0, void 0, i2)),
                super.set(a2, h2);
        }
    }
    pa(t2 = Pe) {
    ...
    set(t2, e2) {
        return (
            Fe(this),
            null == (t2 = this.T(t2, true, false))
                ? this
                : null == e2
                  ? (super.delete(t2), this)
                  : super.set(
                        t2,
                        this.aa(e2, true, true, this.U, false, this.M)
                    )
        );
    }
    Qa(t2) {
        ...
        (t2 = t2[1]),
            (t2 = this.U
                ? void 0 === t2
                    ? null
                    : t2
                : this.aa(t2, false, true, void 0, false, this.M)),
            super.set(e2, t2);
    }
    has(t2) {
    ...
    get(t2) {
        ...
        if (void 0 !== e2) {
            var n2 = this.U;
            return n2
                ? ((n2 = this.aa(e2, false, true, n2, this.va, this.M)) !==
                      e2 && super.set(t2, n2),
                  n2)
                : e2;
        }
            ...
            return 2 & r2
                ...
                : (e2 &&
                      (e2 =
                          ...
                          (!!(32 & r2) && !(64 & r2 || !(16 & r2)))),
                  e2
                      ? (nt(t2, -12293 & (34 | r2)), t2)
                      : De(t2, je, 4 & r2 ? st : n2, true, true));
        }
        return (
            t2.Y === at
                ? ((n2 = t2.u),
                  (t2 = 2 & (r2 = et(n2)) ? t2 : Ve(t2, n2, r2, true)))
                : t2 instanceof Me &&
                  !(2 & t2.M) &&
                  ((n2 = rt(t2.Z(je))), (t2 = new Me(n2, t2.U, t2.T, t2.aa))),
            t2
        );
    }
}
    ...
    return (
        ...
        (null != n2 &&
            (!r2 &&
                0 === n2 &&
                (4096 & e2 || 8192 & e2) &&
                (t2.constructor[J] = 1 + (0 | t2.constructor[J])) < 5 &&
                j(),
            0 !== n2 && !(n2 & e2)))
    );
}
...
function Ye(t2, e2, n2, r2) {
    ...
    if (!(n2 >= i2)) {
        var s2 = t2.length;
        return r2 && 256 & e2 && null != (r2 = t2[s2 - 1][n2])
            ? (Ke(t2, e2, i2, n2) &&
                  null != $ &&
                  ((e2 = (t2 = G ?? (G = {}))[$] || 0) >= 4 ||
                      ((t2[$] = e2 + 1), j())),
...
function en(t2, e2, n2, r2, i2, s2) {
    ...
    if (
        ...
        t3 < c2 && (i2.length = t3),
            (h2 = -4097 & (20 | (h2 = rn(h2, a2)))),
            nt(i2, (h2 &= -8193)),
            2 & h2 && Object.freeze(i2);
    }
    let u2;
    return (
        1 === r2 || (4 === r2 && 32 & h2)
            ? sn(h2) ||
              ((t2 = h2), (h2 |= 2) !== t2 && nt(i2, h2), Object.freeze(i2))
            : ((n2 =
                  5 === r2 &&
                  (!!(32 & h2) ||
                      sn(h2) ||
                      !!(ae == null ? void 0 : ae.get(i2)))),
              (2 === r2 || n2) &&
                  sn(h2) &&
                  ((i2 = H(i2)),
                  (h2 = En((h2 = vn(h2, a2)), a2, s2)),
                  nt(i2, h2),
                  (a2 = qe(o2, a2, e2, i2))),
              sn(h2) || ((e2 = h2), (h2 = En(h2, a2, s2)) !== e2 && nt(i2, h2)),
              n2
                  ? ((u2 = oe(i2)), _e(i2, t2, true))
                  : 2 !== r2 || s2 || (ae == null ? void 0 : ae.delete(i2))),
        u2 || i2
    );
}
...
function dn(t2, e2, n2, r2) {
    ...
    let i2 = et(t2);
    return (
        (e2 = ie((r2 = Ye(t2, i2, n2, r2)), e2, false, i2)) !== r2 &&
            null != e2 &&
            qe(t2, i2, n2, e2),
        e2
    );
...
function gn(t2, e2, n2, r2, i2, s2, o2) {
    ...
    var c2 = tt(h2),
        u2 = h2;
    if (
        (ve(u2, t2), (2 !== i2 && 1 !== i2) || Te(u2, t2), !(u2 = !!(4 & c2)))
    ) {
        var l2 = h2,
            f2 = e2;
        ...
        o3 < s3 && (l2.length = o3),
            (c2 |= 4),
            (c2 = i3 ? 16 | c2 : -17 & c2),
            nt(l2, (c2 = r3 ? 8 | c2 : -9 & c2)),
            t3 && Object.freeze(l2);
    }
    if (
        o2 &&
        !(8 & c2 || (!h2.length && (1 === i2 || (4 === i2 && 32 & c2))))
    ) {
        for (
            sn(c2)
                ? ((h2 = H(h2)), (c2 = vn(c2, e2)), (e2 = qe(a2, e2, r2, h2)))
                : Te(h2, t2),
                n2 = h2,
                o2 = c2,
                l2 = 0;
    ...
    return (
        1 === i2 || (4 === i2 && 32 & c2)
            ? sn(c2) ||
              ((t2 = c2),
              (c2 |= !h2.length || (16 & c2 && (!u2 || 32 & c2)) ? 2 : 2048) !==
                  t2 && nt(h2, c2),
              Object.freeze(h2))
            : ((u2 =
                  5 === i2 &&
                  (!!(32 & c2) ||
                      sn(c2) ||
                      !!(ae == null ? void 0 : ae.get(h2)))),
              (2 === i2 || u2) &&
                  sn(c2) &&
                  ((h2 = H(h2)),
                  (c2 = En((c2 = vn(c2, e2)), e2, s2)),
                  nt(h2, c2),
                  (e2 = qe(a2, e2, r2, h2))),
              sn(c2) || ((r2 = c2), (c2 = En(c2, e2, s2)) !== r2 && nt(h2, c2)),
              u2
                  ? ((d2 = oe(h2)), _e(h2, t2, true))
                  : 2 !== i2 || s2 || (ae == null ? void 0 : ae.delete(h2))),
        d2 || h2
    );
}
...
function wn(t2, e2, n2, r2) {
    const i2 = et(t2.u);
    pt(i2),
        (t2 = gn(t2, i2, n2, e2, 2, true)),
        (n2 = null != r2 ? r2 : new n2()),
        t2.push(n2),
        2 & tt(n2.u) ? Q(t2, 8) : Q(t2, 16);
}
function Tn(t2, e2) {
    return t2 ?? e2;
}
...
function Rn(t2, e2, n2) {
    {
        ...
        if ((pt(h2), null == n2)) qe(a2, h2, e2);
            ...
            var r2,
                i2 = tt(n2),
                s2 = i2,
                o2 = !!(2 & i2) || Object.isFrozen(n2);
            if (((r2 = !o2) && (r2 = void 0 === vt || false), We(t2, i2))) {
                (i2 = 21),
                    o2 &&
                        ((n2 = H(n2)),
                        (s2 = 0),
                        (i2 = En((i2 = vn(i2, h2)), h2, true)));
    ...
    return (
        ...
        255 == n2
            ? e2
                ...
                : t2 * (1 / 0)
            : 0 == n2
              ? 1401298464324817e-60 * t2 * e2
              : t2 * Math.pow(2, n2 - 150) * (e2 + 8388608)
    );
}
function jn(t2) {
    return Un(t2);
...
function qn(t2) {
    ...
    if (((t2 = t2.h), o)) {
        var h2,
            c2 = t2;
        (h2 = s) || (h2 = s = new TextDecoder('utf-8', { fatal: true })),
            (e2 = a2 + e2),
            (c2 = 0 === a2 && e2 === c2.length ? c2 : c2.subarray(a2, e2));
        try {
            var u2 = h2.decode(c2);
        } catch (t3) {
            if (void 0 === i) {
...
function rr(t2) {
    we(t2), (t2 = tr ? t2.u : De(t2.u, Ge, void 0, void 0, false));
    {
        ...
        if (c2) {
            ...
            (i2 !== t2 || o2 || h2) &&
                (e2
                    ? (h2 || o2 || a2) && (i2.length = c2)
                    : (i2 = Array.prototype.slice.call(i2, 0, c2)),
                a2 && i2.push(a2)),
                (h2 = i2);
        } else h2 = t2;
    }
...
function Ir(t2, e2) {
    ...
    const i2 = t2.h;
    return (t3, s2, o2) =>
        i2(t3, s2, o2, r2 || (r2 = Pr(e2).g), n2 || (n2 = Rr(e2)));
}
function Pr(t2) {
    let e2 = t2[Fr];
...
function Nr(t2, e2, n2) {
    ...
    let i2, s2;
    return (t3, o2, a2) =>
        r2(t3, o2, a2, s2 || (s2 = Ur(e2).g), i2 || (i2 = br(e2)), n2);
}
function Ur(t2) {
    let e2 = t2[Or];
...
function Dr(t2, e2) {
    ...
    if ((n2 = t2.X)) {
        ...
        if (r2) {
            ...
            if (
                ((r2 = r2[1]),
                (n2 = (_a2 = n2.P) == null ? void 0 : _a2[e2]),
                !d || n2)
            ) {
                if (r2) {
                    const e3 = Rr(r2),
...
function Br(t2, e2, n2) {
    ...
    for (
        ...
        if (!a3) continue;
        const h2 = n2.X;
        (h2 == null ? void 0 : h2[s3]) &&
            !((_a2 = h2 == null ? void 0 : h2.P) == null ? void 0 : _a2[s3]) &&
            Wr++ < 5 &&
            j(),
            a3(e2, r3, s3);
    }
        ...
        for (let t3 in r2)
            (i2 = +t3),
                !Number.isNaN(i2) &&
                    null != (s2 = r2[t3]) &&
                    (a2 = Dr(n2, i2)) &&
                    (((_b = o2 = n2.X) == null ? void 0 : _b[i2]) &&
                        !((_c = o2 == null ? void 0 : o2.P) == null
                            ? void 0
                            : _c[i2]) &&
                        Wr++ < 5 &&
                        j(),
...
var Hr = Vr(
    function (t2, e2, n2, r2, i2) {
        return (
            2 === t2.h &&
            ((t2 = $n(t2, Ae([void 0, void 0], r2), i2)),
            pt((r2 = et(e2))),
            (i2 = Ye(e2, r2, n2)) instanceof Me
                ? 0 != (2 & i2.M)
                    ? ((i2 = i2.Z()).push(t2), qe(e2, r2, n2, i2))
                    : i2.Qa(t2)
                : Array.isArray(i2)
                  ? (2 & tt(i2) && qe(e2, r2, n2, (i2 = on(i2))), i2.push(t2))
                  : qe(e2, r2, n2, [t2]),
            true)
        );
    },
...
function qr(t2, e2, n2, r2, i2) {
    e2 instanceof nr
        ? (we(e2), (e2 = e2.u))
        : (e2 = Array.isArray(e2) ? Ae(e2, r2) : void 0),
        vr(t2, n2, e2, i2);
}
function Jr(t2, e2, n2) {
    null !=
        (e2 =
            null == e2 || 'string' == typeof e2 || I(e2) || e2 instanceof D
                ? e2
                : void 0) && _r(t2, n2, On(e2).buffer);
}
function Zr(t2, e2, n2) {
    return (
        (5 === t2.h || 2 === t2.h) &&
        ((e2 = Je(e2, et(e2), n2, 2, false)),
        2 == t2.h ? Zn(t2, Gn, e2) : e2.push(Gn(t2.g)),
        true)
    );
}
var Qr;
var ti = Gr(
    ...
    function (t2, e2, n2) {
        null != (e2 = Ht(e2)) &&
            (gr(t2, n2, 1),
            (t2 = t2.g),
            (n2 = It || (It = new DataView(new ArrayBuffer(8)))).setFloat64(
                0,
                +e2,
                true
            ),
            (Pt = n2.getUint32(0, true)),
            (Ot = n2.getUint32(4, true)),
            dr(t2, Pt),
            dr(t2, Ot));
    }
);
var ei = Gr(
    ...
    function (t2, e2, n2) {
        null != (e2 = Ht(e2)) &&
            (gr(t2, n2, 5), (t2 = t2.g), Ut(e2), dr(t2, Pt));
    }
);
...
var si = Gr(function (t2, e2, n2) {
    return (
        0 === t2.h &&
        (Xr(e2, n2, 0 === (t2 = Cn(t2.g, Bt)) ? void 0 : t2), true)
    );
}, zr);
var oi = Gr(
    function (t2, e2, n2) {
...
var hi = jr(
    function (t2, e2, n2) {
        return (
            (0 === t2.h || 2 === t2.h) &&
            ((e2 = Je(e2, et(e2), n2, 2, false)),
            2 == t2.h ? Zn(t2, Un, e2) : e2.push(Un(t2.g)),
            true)
        );
    },
    function (t2, e2, n2) {
...
var ci = Gr(function (t2, e2, n2) {
    return (
        0 === t2.h && (Xr(e2, n2, 0 === (t2 = Un(t2.g)) ? void 0 : t2), true)
    );
}, Kr);
...
var li = Gr(function (t2, e2, n2) {
    return (
        0 === t2.h &&
        (Xr(e2, n2, false === (t2 = Nn(t2.g)) ? void 0 : t2), true)
    );
}, Yr);
var fi = jr(
    function (t2, e2, n2) {
...
Qr = new Er(
    ...
    function (t2, e2, n2, r2, i2) {
        if (Array.isArray(e2))
            for (let s2 = 0; s2 < e2.length; s2++) qr(t2, e2[s2], n2, r2, i2);
    },
    true
);
var yi = Vr(function (t2, e2, n2, r2, i2, s2) {
    return (
        2 === t2.h &&
        (un(e2, et(e2), s2, n2), $n(t2, (e2 = fn(e2, r2, n2)), i2), true)
    );
}, qr);
...
var vi = jr(
    function (t2, e2, n2) {
        return (
            (0 === t2.h || 2 === t2.h) &&
            ((e2 = Je(e2, et(e2), n2, 2, false)),
            2 == t2.h ? Zn(t2, Dn, e2) : e2.push(Dn(t2.g)),
            true)
        );
    },
    function (t2, e2, n2) {
...
var Ei = Gr(
    ...
    function (t2, e2, n2) {
        null != (e2 = Yt(e2)) &&
            ((e2 = parseInt(e2, 10)), gr(t2, n2, 0), fr(t2.g, e2));
    }
);
var wi = class {
    constructor(t2, e2) {
...
var Si = [
    ...
    Gr(
        function (t2, e2, n2) {
            return (
                2 === t2.h &&
                (Xr(e2, n2, (t2 = Jn(t2)) === N() ? void 0 : t2), true)
            );
        },
        function (t2, e2, n2) {
            if (null != e2) {
                if (e2 instanceof nr) {
                    ...
                    return void (
                        r2 &&
                        ((e2 = r2(e2)), null != e2 && _r(t2, n2, On(e2).buffer))
                    );
                }
    ...
    jr(
        function (t2, e2, n2) {
            return (
                (0 === t2.h || 2 === t2.h) &&
                ((e2 = Je(e2, et(e2), n2, 2, false)),
                2 == t2.h ? Zn(t2, jn, e2) : e2.push(Un(t2.g)),
                true)
            );
        },
        function (t2, e2, n2) {
        ...
        g() {
            ...
            return (
                (t2 = (function (t3, e3, n3) {
                    ...
                    return (
                        s2 || (64 & tt(n3) ? Q(n3, 32) : 32 & e3 && Z(n3, 32)),
                        qe(t3, e3, 2, (r2 = new Me(n3, r2, se, void 0))),
                        r2
                    );
                })(t2, e2, Ye(t2, e2, 2))),
                !n2 && yo && (t2.va = true),
...
(Ni[443442058] = [0, Rs, pi, ai, ei, fi, -1]),
    (Ui[443442058] = 1),
    (Ui[514774813] = 1);
...
function So(t2, e2) {
    return (
        (e2 = e2 ? e2.clone() : new Es()),
        void 0 !== t2.displayNamesLocale
            ? $e(e2, 1, ne(t2.displayNamesLocale))
            : void 0 === t2.displayNamesLocale && $e(e2, 1),
        void 0 !== t2.maxResults
            ? xn(e2, 2, t2.maxResults)
            : 'maxResults' in t2 && $e(e2, 2),
        void 0 !== t2.scoreThreshold
            ? Ln(e2, 3, t2.scoreThreshold)
            : 'scoreThreshold' in t2 && $e(e2, 3),
        void 0 !== t2.categoryAllowlist
            ? Rn(e2, 4, t2.categoryAllowlist)
            : 'categoryAllowlist' in t2 && $e(e2, 4),
        void 0 !== t2.categoryDenylist
            ? Rn(e2, 5, t2.categoryDenylist)
            : 'categoryDenylist' in t2 && $e(e2, 5),
        e2
    );
}
function xo(t2, e2 = -1, n2 = '') {
    return {
        categories: t2.map((t3) => ({
            index: Tn(An(t3, 1), 0) ?? -1,
            score: bn(t3, 2) ?? 0,
            categoryName: kn(t3, 3) ?? '',
            displayName: kn(t3, 4) ?? '',
        })),
        headIndex: e2,
        headName: n2,
...
function Lo(t2) {
    ...
    if (
        ((e2 = (_a2 = pn(t2, is, 4)) == null ? void 0 : _a2.h()) &&
            (s2.boundingBox = {
                originX: An(e2, 1) ?? 0,
                originY: An(e2, 2) ?? 0,
                width: An(e2, 3) ?? 0,
        ...
        (_b = pn(t2, is, 4)) == null ? void 0 : _b.g().length)
    )
...
function Do() {
    ...
    return (
        ...
        (!(function (t3 = navigator) {
            return (
                (t3 = t3.userAgent).includes('Safari') && !t3.includes('Chrome')
            );
        })(t2) ||
            !!(
...
function Vo(t2, e2, n2) {
    ...
    if (
        ...
        !(n2 =
            t2.i.canvas.getContext('webgl2') ||
            t2.i.canvas.getContext('webgl')))
    )
        throw Error(
...
function Ko(t2, e2) {
    ...
    'string' == typeof e2
        ...
        : e2 instanceof Uint8Array &&
          ($e(n2, 1, lt(e2, false, false)), $e(n2, 2)),
        yn(t2.baseOptions, 0, 1, n2);
}
function Yo(t2) {
    try {
...
function qo(t2, e2) {
    (t2.A = new Vi()),
        Bi(t2.A, 'PassThroughCalculator'),
        Gi(t2.A, 'free_memory'),
        ji(t2.A, 'free_memory_unused_out'),
        Ki(e2, 'free_memory'),
        zi(e2, t2.A);
}
function Jo(t2, e2) {
...
var Qo = class {
    ...
    l(t2, e2 = true) {
        ...
        if (e2) {
            ...
            if (
                ((_a2 = t2.baseOptions) == null
                    ? void 0
                    : _a2.modelAssetBuffer) &&
            ...
            if (
                !(
                    ((_c = pn(this.baseOptions, Ss, 1)) == null
                        ? void 0
                        : _c.g()) ||
                    ((_d = pn(this.baseOptions, Ss, 1)) == null
                        ? void 0
                        : _d.h()) ||
                    ((_e2 = t2.baseOptions) == null
                        ? void 0
                        : _e2.modelAssetBuffer) ||
            ...
            if (
                ((function (t3, e4) {
                    ...
                    'delegate' in e4 &&
                        ('GPU' === e4.delegate
                            ? ((e4 = n2), (r2 = new Li()), _n(e4, 2, ks, r2))
                            : ((e4 = n2), (r2 = new Mi()), _n(e4, 4, ks, r2))),
                        yn(t3.baseOptions, 0, 3, n2);
                })(this, e3),
                e3.modelAssetPath)
            )
...
(Qo.prototype.close = Qo.prototype.close),
    (function (e2, n2) {
        ...
        var r2,
            i2 = t;
        e2[0] in i2 ||
            void 0 === i2.execScript ||
            i2.execScript('var ' + e2[0]);
        for (; e2.length && (r2 = e2.shift()); )
            e2.length || void 0 === n2
                ? (i2 =
                      i2[r2] && i2[r2] !== Object.prototype[r2]
                          ? i2[r2]
                          : (i2[r2] = {}))
                : (i2[r2] = n2);
    })('TaskRunner', Qo);
...
function na(t2, e2, n2) {
    const r2 = t2.g;
    if (
        ((n2 = ta(r2.createShader(n2), 'Failed to create WebGL shader')),
        r2.shaderSource(n2, e2),
        r2.compileShader(n2),
        !r2.getShaderParameter(n2, r2.COMPILE_STATUS))
    )
        throw Error(
            `Could not compile WebGL shader: ${r2.getShaderInfoLog(n2)}`
        );
    return r2.attachShader(t2.h, n2), n2;
}
function ra(t2, e2) {
    const n2 = t2.g,
        r2 = ta(n2.createVertexArray(), 'Failed to create vertex array');
    n2.bindVertexArray(r2);
    const i2 = ta(n2.createBuffer(), 'Failed to create buffer');
    n2.bindBuffer(n2.ARRAY_BUFFER, i2),
        n2.enableVertexAttribArray(t2.R),
        n2.vertexAttribPointer(t2.R, 2, n2.FLOAT, false, 0, 0),
        n2.bufferData(
            n2.ARRAY_BUFFER,
    ...
    return (
        ...
        n2.enableVertexAttribArray(t2.J),
        n2.vertexAttribPointer(t2.J, 2, n2.FLOAT, false, 0, 0),
        n2.bufferData(
            n2.ARRAY_BUFFER,
            new Float32Array(
...
function sa(t2, e2, n2, r2) {
    return (
        ...
        t2.h || (t2.m(), t2.C()),
        n2
            ? (t2.s || (t2.s = ra(t2, true)), (n2 = t2.s))
            : (t2.v || (t2.v = ra(t2, false)), (n2 = t2.v)),
        e2.useProgram(t2.h),
        n2.bind(),
        t2.l(),
        (t2 = r2()),
...
function oa(t2, e2, n2) {
    return (
        ia(t2, e2),
        (t2 = ta(e2.createTexture(), 'Failed to create texture')),
...
function aa(t2, e2, n2) {
    ia(t2, e2),
        t2.A ||
            (t2.A = ta(e2.createFramebuffer(), 'Failed to create framebuffe.')),
        e2.bindFramebuffer(e2.FRAMEBUFFER, t2.A),
...
var ca = class {
    ...
    m() {
        ...
        if (
            ...
            (this.ca = na(this, this.H(), t2.FRAGMENT_SHADER)),
        ...
        (this.R = t2.getAttribLocation(this.h, 'aVertex')),
            (this.J = t2.getAttribLocation(this.h, 'aTex'));
    }
    C() {}
    l() {}
    close() {
        if (this.h) {
            ...
            t2.deleteProgram(this.h),
                t2.deleteShader(this.da),
                t2.deleteShader(this.ca);
        }
...
var ua = class extends ca {
    ...
    C() {
        ...
        t2.activeTexture(t2.TEXTURE1),
            (this.B = oa(this, t2, t2.LINEAR)),
            t2.activeTexture(t2.TEXTURE2),
            (this.j = oa(this, t2, t2.NEAREST));
    }
    m() {
        super.m();
        const t2 = this.g;
    ...
    l() {
        super.l();
        const t2 = this.g;
        t2.uniform1i(this.K, 0),
            t2.uniform1i(this.L, 1),
            t2.uniform1i(this.V, 2);
    }
    close() {
...
var la = class extends ca {
    ...
    l() {
        ...
        t2.uniform1i(this.I, 0),
            t2.uniform1i(this.K, 1),
            t2.uniform1i(this.L, 2);
    }
    close() {
        this.j && this.g.deleteTexture(this.j),
            this.B && this.g.deleteTexture(this.B),
...
function _a(t2) {
    ...
    return (
        n2 ||
            ((n2 = oa(ya(t2), e2, t2.m ? e2.LINEAR : e2.NEAREST)),
            t2.g.push(n2),
            (t2.j = true)),
            ...
            if (e2 instanceof Uint8Array) n2 = new Uint8Array(e2);
                    ...
                    throw Error(`Type is not supported: ${e2}`);
                {
                    ...
                    t3.activeTexture(t3.TEXTURE1),
                        (n2 = oa(e3, t3, this.m ? t3.LINEAR : t3.NEAREST)),
    ...
    sa(i2, s2, true, () => {
        !(function (t4, e3, n3, r3) {
            ...
            if (
                ...
                i3.bindTexture(i3.TEXTURE_2D, t4.B),
                i3.texImage2D(
                    i3.TEXTURE_2D,
                    0,
                    i3.RGBA,
                ...
                r3.forEach((t5, n4) => {
                    if (4 !== t5.length)
                        throw Error(
                            `Color at index ${n4} is not a four-channel value.`
                        );
                    (e4[4 * n4] = t5[0]),
                        (e4[4 * n4 + 1] = t5[1]),
                        (e4[4 * n4 + 2] = t5[2]),
...
function Ma(t2, e2, n2, r2) {
    ...
    sa(s2, i2, true, () => {
        ...
        t3.activeTexture(t3.TEXTURE0),
            ...
            t3.activeTexture(t3.TEXTURE2),
            t3.bindTexture(t3.TEXTURE_2D, s2.B),
            t3.texImage2D(
                t3.TEXTURE_2D,
                0,
                t3.RGBA,
...
var Ia = class {
    ...
    Ca(t2, e2) {
        if (t2) {
            ...
            var r2 = n2.canvas,
                i2 = 0;
            for (const s2 of t2)
                (n2.fillStyle = ka(e2.fillColor, { index: i2, from: s2 })),
                    (n2.strokeStyle = ka(e2.color, { index: i2, from: s2 })),
                    (n2.lineWidth = ka(e2.lineWidth, { index: i2, from: s2 })),
                    (t2 = new Path2D()).arc(
                        s2.x * r2.width,
                        s2.y * r2.height,
                        ka(e2.radius, { index: i2, from: s2 }),
                        0,
                        2 * Math.PI
                    ),
                    n2.fill(t2),
    ...
    Ba(t2, e2, n2) {
        if (t2 && e2) {
            ...
            for (const o2 of e2) {
                ...
                e2 &&
                    a2 &&
                    ((r2.strokeStyle = ka(n2.color, {
                        index: s2,
                        from: e2,
                        to: a2,
                    })),
                    (r2.lineWidth = ka(n2.lineWidth, {
                        index: s2,
                        from: e2,
                        to: a2,
                    })),
    ...
    ya(t2, e2) {
        ...
        (e2 = ba(e2)),
            n2.save(),
            n2.beginPath(),
            (n2.lineWidth = ka(e2.lineWidth, {})),
            (n2.strokeStyle = ka(e2.color, {})),
            (n2.fillStyle = ka(e2.fillColor, {})),
    ...
    close() {
        ...
        (_a2 = this.g) == null ? void 0 : _a2.close(),
            ...
            (this.h = void 0),
            (_c = this.m) == null ? void 0 : _c.close(),
            (this.m = void 0);
    }
};
function Pa(t2, e2) {
...
function Da(t2) {
    ...
    let n2 = Pa(t2, 2);
    return (
        n2 || ((n2 = oa(Ua(t2), e2)), t2.g.push(n2), (t2.m = true)),
        e2.bindTexture(e2.TEXTURE_2D, n2),
        n2
    );
}
...
(Ia.prototype.close = Ia.prototype.close),
    ...
    (Ia.lerp = function (t2, e2, n2, r2, i2) {
        return Sa(
...
var ja = class {
    ...
    close() {
        this.j && Pa(this, 1).close(),
            this.m && Na(this).deleteTexture(Pa(this, 2)),
            (Va = -1);
    }
};
...
async function Ka(t2, e2, n2) {
    return (async function (t3, e3, n3, r2) {
        ...
        t2,
        n2.canvas ?? (Do() ? void 0 : document.createElement('canvas')),
        e2,
        n2
    );
}
...
function Ja(t2, e2, n2, r2) {
    ...
    return (
        (t2 = new wa([i2], n2, false, t2.g.i.canvas, t2.R, s2, e2)),
        r2 ? t2.clone() : t2
    );
}
        ...
        if (
            ('runningMode' in t2 &&
                Sn(
                    this.baseOptions,
                    2,
                    !!t2.runningMode && 'IMAGE' !== t2.runningMode
                ),
...
var Qa = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'image_in', 'norm_rect_in', false),
            (this.j = { detections: [] }),
            yn((t2 = this.h = new Fs()), 0, 1, (e2 = new xs())),
            Ln(this.h, 2, 0.5),
            Ln(this.h, 3, 0.3);
    }
    get baseOptions() {
    ...
    m() {
        ...
        er(e2, Is, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.face_detector.FaceDetectorGraph'),
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect_in'),
            ji(n2, 'DETECTIONS:detections'),
            n2.o(e2),
            zi(t2, n2),
...
(Qa.prototype.detectForVideo = Qa.prototype.F),
    ...
    (Qa.createFromModelPath = async function (t2, e2) {
...
var lh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'image_in', 'norm_rect', false),
            (this.j = {
                faceLandmarks: [],
                faceBlendshapes: [],
                facialTransformationMatrixes: [],
            ...
            (this.outputFacialTransformationMatrixes =
                this.outputFaceBlendshapes =
                    false),
            yn((t2 = this.h = new Ds()), 0, 1, (e2 = new xs())),
            (this.v = new Us()),
    ...
    m() {
        ...
        er(e2, js, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph'),
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'NORM_LANDMARKS:face_landmarks'),
            n2.o(e2),
            zi(t2, n2),
            ...
            this.outputFacialTransformationMatrixes &&
                (Yi(t2, 'face_geometry'),
                ji(n2, 'FACE_GEOMETRY:face_geometry'),
                        ...
                        for (const e4 of t3)
                            (t3 = pn(Cs(e4), us, 2)) &&
                                this.j.facialTransformationMatrixes.push({
                                    rows: Tn(An(t3, 1), 0) ?? 0,
                                    columns: Tn(An(t3, 2), 0) ?? 0,
                                    data: en(t3, 3, Ht, tn()).slice() ?? [],
                                });
                    $o(this, e3);
                }),
...
(lh.prototype.detectForVideo = lh.prototype.F),
    ...
    (lh.createFromModelPath = function (t2, e2) {
...
var fh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'image_in', 'norm_rect', true),
            yn((t2 = this.j = new Vs()), 0, 1, (e2 = new xs()));
    }
    get baseOptions() {
    ...
    m() {
        ...
        er(e2, Xs, this.j);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.face_stylizer.FaceStylizerGraph'),
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'STYLIZED_IMAGE:stylized_image'),
            n2.o(e2),
            zi(t2, n2),
            this.g.W('stylized_image', (t3, e3) => {
                var n3 = !this.h,
                    r2 = t3.data,
                    i2 = t3.width;
                ...
                if (r2 instanceof Uint8Array)
                    if (r2.length === 3 * s2) {
                        ...
                        if (r2.length !== 4 * s2)
                            throw Error(
                                'Unsupported channel count: ' + r2.length / s2
                            );
                        r2 = new ImageData(
...
(fh.prototype.stylize = fh.prototype.Ra),
    ...
    (fh.createFromModelPath = function (t2, e2) {
...
function mh(t2, e2 = true) {
    ...
    for (const i2 of t2) {
        ...
        for (const n3 of r2.g())
            (r2 = e2 && null != An(n3, 1) ? Tn(An(n3, 1), 0) : -1),
                t2.push({
                    score: bn(n3, 2) ?? 0,
                    index: r2,
                    categoryName: kn(n3, 3) ?? '',
                    displayName: kn(n3, 4) ?? '',
                });
        n2.push(t2);
    }
...
var yh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'image_in', 'norm_rect', false),
            ...
            (this.worldLandmarks = []),
            (this.handedness = []),
            yn((t2 = this.j = new Js()), 0, 1, (e2 = new xs())),
            (this.s = new qs()),
    ...
    o(t2) {
        var _a2, _b, _c, _d;
        if (
            (xn(this.v, 3, t2.numHands ?? 1),
            'minHandDetectionConfidence' in t2 &&
                Ln(this.v, 2, t2.minHandDetectionConfidence ?? 0.5),
            'minTrackingConfidence' in t2 &&
                Ln(this.s, 4, t2.minTrackingConfidence ?? 0.5),
            'minHandPresenceConfidence' in t2 &&
                Ln(this.C, 2, t2.minHandPresenceConfidence ?? 0.5),
            ...
            var e2 = new Hs(),
                ...
                r2 = So(
                    t2.cannedGesturesClassifierOptions,
                    (_a2 = pn(this.h, Hs, 3)) == null ? void 0 : _a2.h()
                );
            yn(n2, 0, 2, r2), yn(this.h, 0, 3, e2);
        } else
            void 0 === t2.cannedGesturesClassifierOptions &&
                ((_b = pn(this.h, Hs, 3)) == null ? void 0 : _b.g());
        return (
            t2.customGesturesClassifierOptions
                ? (yn(
                      ...
                      (r2 = So(
                          t2.customGesturesClassifierOptions,
                          (_c = pn(this.h, Hs, 4)) == null ? void 0 : _c.h()
                      ))
                  ),
                  yn(this.h, 0, 4, e2))
                : void 0 === t2.customGesturesClassifierOptions &&
                  ((_d = pn(this.h, Hs, 4)) == null ? void 0 : _d.g()),
            this.l(t2)
        );
    }
    Ma(t2, e2) {
    ...
    m() {
        ...
        Ki(t2, 'image_in'),
            Ki(t2, 'norm_rect'),
            Yi(t2, 'hand_gestures'),
            Yi(t2, 'hand_landmarks'),
            Yi(t2, 'world_hand_landmarks'),
            Yi(t2, 'handedness');
        const e2 = new Ci();
        er(e2, io, this.j);
        const n2 = new Vi();
        Bi(
            ...
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'HAND_GESTURES:hand_gestures'),
            ji(n2, 'LANDMARKS:hand_landmarks'),
            ji(n2, 'WORLD_LANDMARKS:world_hand_landmarks'),
            ji(n2, 'HANDEDNESS:handedness'),
            n2.o(e2),
            zi(t2, n2),
...
(yh.prototype.recognizeForVideo = yh.prototype.Na),
    ...
    (yh.createFromModelPath = function (t2, e2) {
...
var vh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'image_in', 'norm_rect', false),
            ...
            (this.worldLandmarks = []),
            (this.handedness = []),
            yn((t2 = this.h = new qs()), 0, 1, (e2 = new xs())),
            (this.s = new $s()),
    ...
    o(t2) {
        return (
            ...
            'minTrackingConfidence' in t2 &&
                Ln(this.h, 4, t2.minTrackingConfidence ?? 0.5),
            'minHandPresenceConfidence' in t2 &&
                Ln(this.s, 2, t2.minHandPresenceConfidence ?? 0.5),
            this.l(t2)
        );
    }
    D(t2, e2) {
    ...
    m() {
        ...
        er(e2, ro, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph'),
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'LANDMARKS:hand_landmarks'),
            ji(n2, 'WORLD_LANDMARKS:world_hand_landmarks'),
            ...
            this.g.attachProtoVectorListener('handedness', (t3, e3) => {
                ...
                for (const e4 of t3) {
                    ...
                    for (const e5 of t3.g())
                        n4.push({
                            score: bn(e5, 2) ?? 0,
                            index: Tn(An(e5, 1), 0) ?? -1,
                            categoryName: kn(e5, 3) ?? '',
                            displayName: kn(e5, 4) ?? '',
                        });
                    i2.push(n4);
                }
...
(vh.prototype.detectForVideo = vh.prototype.F),
    ...
    (vh.createFromModelPath = function (t2, e2) {
...
var bh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'input_frames_image', null, false),
            (this.h = {
                faceLandmarks: [],
                faceBlendshapes: [],
                poseLandmarks: [],
            ...
            (this.outputPoseSegmentationMasks = this.outputFaceBlendshapes =
                false),
            yn((t2 = this.j = new ho()), 0, 1, (e2 = new xs())),
            (this.K = new $s()),
    ...
    o(t2) {
        return (
            ...
            'minFaceSuppressionThreshold' in t2 &&
                Ln(this.s, 3, t2.minFaceSuppressionThreshold ?? 0.3),
            'minFacePresenceConfidence' in t2 &&
                Ln(this.I, 2, t2.minFacePresenceConfidence ?? 0.5),
            'outputFaceBlendshapes' in t2 &&
                (this.outputFaceBlendshapes = !!t2.outputFaceBlendshapes),
            'minPoseDetectionConfidence' in t2 &&
                Ln(this.v, 2, t2.minPoseDetectionConfidence ?? 0.5),
            'minPoseSuppressionThreshold' in t2 &&
                Ln(this.v, 3, t2.minPoseSuppressionThreshold ?? 0.3),
            'minPosePresenceConfidence' in t2 &&
                Ln(this.L, 2, t2.minPosePresenceConfidence ?? 0.5),
            'outputPoseSegmentationMasks' in t2 &&
                (this.outputPoseSegmentationMasks =
                    !!t2.outputPoseSegmentationMasks),
            'minHandLandmarksConfidence' in t2 &&
                Ln(this.K, 2, t2.minHandLandmarksConfidence ?? 0.5),
            this.l(t2)
        );
    }
    D(t2, e2, n2) {
        const r2 = 'function' != typeof e2 ? e2 : {};
        return (
            (this.C = 'function' == typeof e2 ? e2 : n2),
            wh(this),
            $a(this, t2, r2),
            Th(this)
        );
    ...
    F(t2, e2, n2, r2) {
        ...
        return (
            (this.C = 'function' == typeof n2 ? n2 : r2),
            wh(this),
            qa(this, t2, i2, e2),
            Th(this)
        );
    ...
    m() {
        var t2 = new $i();
        Ki(t2, 'input_frames_image'),
            Yi(t2, 'pose_landmarks'),
            Yi(t2, 'pose_world_landmarks'),
            Yi(t2, 'face_landmarks'),
            Yi(t2, 'left_hand_landmarks'),
            Yi(t2, 'left_hand_world_landmarks'),
            Yi(t2, 'right_hand_landmarks'),
            Yi(t2, 'right_hand_world_landmarks');
        const e2 = new Ci(),
            n2 = new ki();
        an(
            n2,
            ...
            (function (t3, e3) {
                if (null != e3)
                    if (Array.isArray(e3))
                        ...
                        if (
                            !('string' == typeof e3 || e3 instanceof D || I(e3))
                        )
                            throw Error(
        ...
        Bi(
            ...
            wn(r2, 8, ki, n2),
            Gi(r2, 'IMAGE:input_frames_image'),
            ji(r2, 'POSE_LANDMARKS:pose_landmarks'),
            ji(r2, 'POSE_WORLD_LANDMARKS:pose_world_landmarks'),
            ji(r2, 'FACE_LANDMARKS:face_landmarks'),
            ji(r2, 'LEFT_HAND_LANDMARKS:left_hand_landmarks'),
            ji(r2, 'LEFT_HAND_WORLD_LANDMARKS:left_hand_world_landmarks'),
            ji(r2, 'RIGHT_HAND_LANDMARKS:right_hand_landmarks'),
            ji(r2, 'RIGHT_HAND_WORLD_LANDMARKS:right_hand_world_landmarks'),
            r2.o(e2),
            zi(t2, r2),
            qo(this, t2),
            ...
            this.outputPoseSegmentationMasks &&
                (ji(r2, 'POSE_SEGMENTATION_MASK:pose_segmentation_mask'),
                Jo(this, 'pose_segmentation_mask'),
                this.g.W('pose_segmentation_mask', (t3, e3) => {
                    (this.h.poseSegmentationMasks = [
                        Ja(this, t3, true, !this.C),
                    ]),
                        $o(this, e3);
                }),
            ...
            this.outputFaceBlendshapes &&
                (Yi(t2, 'extra_blendshapes'),
                ji(r2, 'FACE_BLENDSHAPES:extra_blendshapes'),
                this.g.attachProtoListener('extra_blendshapes', (t3, e3) => {
                    var n3 = this.h.faceBlendshapes;
                    this.outputFaceBlendshapes &&
                        ((t3 = es(t3)), n3.push(xo(t3.g() ?? []))),
                        $o(this, e3);
                }),
...
(bh.prototype.detectForVideo = bh.prototype.F),
    ...
    (bh.createFromModelPath = function (t2, e2) {
...
var kh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'input_image', 'norm_rect', true),
            (this.j = { classifications: [] }),
            yn((t2 = this.h = new lo()), 0, 1, (e2 = new xs()));
    }
    get baseOptions() {
        return pn(this.h, xs, 1);
    }
    ...
    m() {
        ...
        er(e2, fo, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.image_classifier.ImageClassifierGraph'),
            Gi(n2, 'IMAGE:input_image'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'CLASSIFICATIONS:classifications'),
            n2.o(e2),
            zi(t2, n2),
            this.g.attachProtoListener('classifications', (t3, e3) => {
                (this.j = (function (t4) {
                    const e4 = {
                        classifications: mn(t4, ds, 1).map((t5) => {
                            var _a2;
                            return xo(
                                ((_a2 = pn(t5, Qi, 4)) == null
                                    ? void 0
                    ...
                    return (
                        null != Qt(ze(t4, 2)) &&
                            (e4.timestampMs = Tn(Qt(ze(t4, 2)), 0)),
                        e4
                    );
                })(ps(t3))),
                    $o(this, e3);
...
(kh.prototype.classifyForVideo = kh.prototype.xa),
    ...
    (kh.createFromModelPath = function (t2, e2) {
...
var Sh = class extends Za {
    ...
    o(t2) {
        var e2 = this.h,
            n2 = pn(this.h, Ts, 2);
        return (
            (n2 = n2 ? n2.clone() : new Ts()),
            void 0 !== t2.l2Normalize
                ? Sn(n2, 1, t2.l2Normalize)
                : 'l2Normalize' in t2 && $e(n2, 1),
            void 0 !== t2.quantize
                ? Sn(n2, 2, t2.quantize)
                : 'quantize' in t2 && $e(n2, 2),
            yn(e2, 0, 2, n2),
            this.l(t2)
        );
    }
    ...
    m() {
        ...
        er(e2, go, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph'),
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'EMBEDDINGS:embeddings_out'),
            n2.o(e2),
            zi(t2, n2),
            this.g.attachProtoListener('embeddings_out', (t3, e3) => {
                (t3 = vs(t3)),
                    (this.embeddings = (function (t4) {
                        return {
                            embeddings: mn(t4, ys, 1).map((t5) => {
                                var _a2, _b;
                                const e4 = {
                                    headIndex: Tn(An(t5, 3), 0) ?? -1,
                                    headName: kn(t5, 4) ?? '',
                                };
...
(Sh.cosineSimilarity = function (t2, e2) {
    ...
    (Sh.createFromModelPath = function (t2, e2) {
...
var Fh = class extends Za {
    ...
    o(t2) {
        return (
            void 0 !== t2.displayNamesLocale
                ? $e(this.h, 2, ne(t2.displayNamesLocale))
                : 'displayNamesLocale' in t2 && $e(this.h, 2),
    ...
    J() {
        !(function (t2) {
            var _a2, _b;
            const e2 = mn(t2.ga(), Vi, 1).filter((t3) =>
                kn(t3, 1).includes(
            ...
            1 === e2.length &&
                (
                    ((_b =
                        (_a2 = pn(e2[0], Ci, 7)) == null ? void 0 : _a2.l()) ==
                    null
                        ? void 0
    ...
    m() {
        ...
        er(e2, wo, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph'),
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            n2.o(e2),
            zi(t2, n2),
            ...
            this.outputConfidenceMasks &&
                (Yi(t2, 'confidence_masks'),
                ji(n2, 'CONFIDENCE_MASKS:confidence_masks'),
                Jo(this, 'confidence_masks'),
                this.g.fa('confidence_masks', (t3, e3) => {
                    (this.confidenceMasks = t3.map((t4) =>
                        Ja(this, t4, true, !this.j)
                    )),
                        $o(this, e3);
                }),
            ...
            this.outputCategoryMask &&
                (Yi(t2, 'category_mask'),
                ji(n2, 'CATEGORY_MASK:category_mask'),
                Jo(this, 'category_mask'),
                this.g.W('category_mask', (t3, e3) => {
                    (this.categoryMask = Ja(this, t3, false, !this.j)),
                        $o(this, e3);
                }),
                this.g.attachEmptyPacketListener('category_mask', (t3) => {
                    (this.categoryMask = void 0), $o(this, t3);
                })),
            Yi(t2, 'quality_scores'),
            ji(n2, 'QUALITY_SCORES:quality_scores'),
...
var Xh = class extends Za {
    ...
    ha(t2, e2, n2, r2) {
        ...
        if (e2.keypoint) {
            var a2 = new Uh();
            Sn(a2, 3, true),
                Ln(a2, 1, e2.keypoint.x),
                Ln(a2, 2, e2.keypoint.y),
                _n(s2, 5, jh, a2);
        } else {
            if (!e2.scribble)
...
(Xh.prototype.segment = Xh.prototype.ha),
    ...
    (Xh.createFromModelPath = function (t2, e2) {
...
var Hh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'input_frame_gpu', 'norm_rect', false),
            (this.j = { detections: [] }),
            yn((t2 = this.h = new To()), 0, 1, (e2 = new xs()));
    }
    get baseOptions() {
        return pn(this.h, xs, 1);
    }
    ...
    o(t2) {
        return (
            ...
            void 0 !== t2.maxResults
                ...
                : 'maxResults' in t2 && $e(this.h, 3),
            void 0 !== t2.scoreThreshold
                ? Ln(this.h, 4, t2.scoreThreshold)
                : 'scoreThreshold' in t2 && $e(this.h, 4),
            void 0 !== t2.categoryAllowlist
                ? Rn(this.h, 5, t2.categoryAllowlist)
                : 'categoryAllowlist' in t2 && $e(this.h, 5),
            void 0 !== t2.categoryDenylist
                ? Rn(this.h, 6, t2.categoryDenylist)
                : 'categoryDenylist' in t2 && $e(this.h, 6),
            this.l(t2)
        );
    }
    D(t2, e2) {
    ...
    m() {
        ...
        er(e2, Ao, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.ObjectDetectorGraph'),
            Gi(n2, 'IMAGE:input_frame_gpu'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'DETECTIONS:detections'),
            n2.o(e2),
            zi(t2, n2),
...
(Hh.prototype.detectForVideo = Hh.prototype.F),
    ...
    (Hh.createFromModelPath = async function (t2, e2) {
...
var Yh = class extends Za {
    constructor(t2, e2) {
        super(new za(t2, e2), 'image_in', 'norm_rect', false),
            ...
            yn((t2 = this.h = new bo()), 0, 1, (e2 = new xs())),
            (this.v = new ao()),
            yn(this.h, 0, 3, this.v),
            (this.j = new oo()),
            yn(this.h, 0, 2, this.j),
    ...
    o(t2) {
        return (
            ...
            'minTrackingConfidence' in t2 &&
                Ln(this.h, 4, t2.minTrackingConfidence ?? 0.5),
            'minPosePresenceConfidence' in t2 &&
                Ln(this.v, 2, t2.minPosePresenceConfidence ?? 0.5),
            'outputSegmentationMasks' in t2 &&
                (this.outputSegmentationMasks =
                    t2.outputSegmentationMasks ?? false),
            this.l(t2)
        );
    }
    D(t2, e2, n2) {
        const r2 = 'function' != typeof e2 ? e2 : {};
        return (
            (this.s = 'function' == typeof e2 ? e2 : n2),
            zh(this),
            $a(this, t2, r2),
            Kh(this)
        );
    ...
    F(t2, e2, n2, r2) {
        const i2 = 'function' != typeof n2 ? n2 : {};
        return (
            (this.s = 'function' == typeof n2 ? n2 : r2),
            zh(this),
            qa(this, t2, i2, e2),
            Kh(this)
        );
    ...
    m() {
        ...
        Ki(t2, 'image_in'),
            Ki(t2, 'norm_rect'),
            Yi(t2, 'normalized_landmarks'),
            Yi(t2, 'world_landmarks'),
            Yi(t2, 'segmentation_masks');
        const e2 = new Ci();
        er(e2, ko, this.h);
        const n2 = new Vi();
        Bi(n2, 'mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph'),
            Gi(n2, 'IMAGE:image_in'),
            Gi(n2, 'NORM_RECT:norm_rect'),
            ji(n2, 'NORM_LANDMARKS:normalized_landmarks'),
            ji(n2, 'WORLD_LANDMARKS:world_landmarks'),
            n2.o(e2),
            zi(t2, n2),
            qo(this, t2),
            this.g.attachProtoVectorListener(
            ...
            this.outputSegmentationMasks &&
                (ji(n2, 'SEGMENTATION_MASK:segmentation_masks'),
                Jo(this, 'segmentation_masks'),
                this.g.fa('segmentation_masks', (t3, e3) => {
                    (this.segmentationMasks = t3.map((t4) =>
                        Ja(this, t4, true, !this.s)
                    )),
                        $o(this, e3);
                }),
