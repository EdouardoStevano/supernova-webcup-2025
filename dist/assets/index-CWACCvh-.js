const __vite__mapDeps = (
    ...
    d = m.f ||
        (m.f = [
            'assets/index-CbxdogPr.js',
            'assets/index-BoZEYj4b.js',
            'assets/index-G9epB887.css',
            'assets/mainBuilder-CRH3qhco.js',
...
const i = s.lazy(() =>
        o(() => import('./index-CbxdogPr.js'), __vite__mapDeps([0, 1, 2]))
    ),
    _ = s.lazy(() =>
        o(() => import('./mainBuilder-CRH3qhco.js'), __vite__mapDeps([3, 1, 2]))
    ),
    u = s.lazy(() =>
        o(
