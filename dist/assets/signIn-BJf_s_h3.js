import { r as a, u as N, d as k, j as e, L as n } from './index-i9ws2I_8.js';
import {
    u as S,
    L as C,
    D as B,
...
import { B as g } from './index-D7RVabCY.js';
...
const G = () => {
    ...
    R = () => {
        ...
        return e.jsx('div', {
            className:
                'sign-in pointBackground flex h-screen flex-row bg-transparent dark:bg-gray-900',
            onKeyDown: j,
            children: e.jsxs('div', {
                className:
                    'sign-in-right flex h-screen w-full flex-col justify-between px-9 py-4',
                children: [
                    e.jsxs('div', {
                        className:
                            ...
                            e.jsx('div', {
                                ...
                                children: e.jsxs('div', {
                                    ...
                                    children: [
                                        e.jsx('div', {
                                            className:
                                                'sign-image2 floating-element-vertical bg-secondary-600 absolute top-[14vh] left-[10vw] h-[40%] w-[20%] -rotate-12 rounded-2xl rounded-b-[100%] shadow-xl shadow-slate-300 outline outline-offset-2 outline-yellow-300 transition hover:-translate-y-7 dark:shadow-slate-800',
                                        }),
                                        e.jsxs('div', {
                                            className:
                            ...
                            e.jsx('div', {
                                ...
                                children: e.jsxs('div', {
                                    ...
                                    children: [
                                        e.jsx('div', {
                                            className:
                                                'sign-image bg-success-600 floating-element-vertical-right absolute right-[10vw] bottom-[17vh] mt-[130px] h-[40%] w-[18%] rotate-12 rounded-2xl rounded-ss-[100%] shadow-xl shadow-slate-300 outline outline-offset-2 outline-teal-400 transition hover:-translate-y-4 dark:shadow-slate-800',
                                        }),
                                        e.jsx('img', {
                                            src: c,
                                            className:
