 ...
 */ var rt = {
    ...
    Qi = function (t, e) {
        ...
        if (
            ((e._time ||
                ...
                ((i = be(t.rawTime(), e)),
                (!e._dur || ce(0, e.totalDuration(), i) - e._tTime > G) &&
                    e.render(i, !0)),
    ...
    Wr = function u(t) {
        var e = t.parent;
        return (
            e && e._ts && e._initted && !e._lock && (e.rawTime() < 0 || u(e))
        );
    },
    Ye = function (t) {
        var e = t.data;
    ...
    tr = function (t) {
        ...
        return (
            ...
            function (c, d, p) {
                ...
                if (!m) {
                    if (
                        ((b = e.grid === 'auto' ? 0 : (e.grid || [1, ct])[1]),
                        !b)
                    ) {
                        for (
                            P = -1e8;
                            P < (P = p[b++].getBoundingClientRect().left) &&
                            b < _;
    ...
    or = function (t, e, i) {
        ...
        if (!r) {
            if (
                (t.substr(-1) === ',' && (t = t.substr(0, t.length - 1)), ie[t])
            )
                r = ie[t];
            else if (t.charAt(0) === '#') {
                if (
                ...
                if (((r = p = t.match(Ne)), !e))
                    ...
                    return (
                        (r = t.match(Ii)), i && r.length < 4 && (r[3] = 1), r
                    );
                ...
                wake: function () {
                    Vi &&
                        (!Be &&
                            ...
                            (ei = ht.document || {}),
                            (nt.gsap = J),
                            (ht.gsapVersions || (ht.gsapVersions = [])).push(
                                J.version
                            ),
                            Ui(
                                xe ||
        ...
        return (
            ...
            (t.totalTime = function (i, r) {
                ...
                if (n && n.smoothChildTiming && this._ts) {
                    for (
                        Ce(this, i), !n._dp || n.parent || Qi(n, this);
                        n && n.parent;
            ...
            (t.repeatDelay = function (i) {
                if (arguments.length) {
                    var r = this._time;
                    return (
                        (this._rDelay = i), vi(this), r ? this.time(r) : this
                    );
                }
                return this._rDelay;
            }),
    ...
    return (
        ...
        (e.render = function (r, n, s) {
            ...
            if (
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            ...
                            (a = O ? 0 : h % f ? f : h),
                            (this._lock = 1),
                            (this.render(a || (P ? 0 : B(_ * m)), n, !f)._lock =
                                0),
                            (this._tTime = h),
                ...
                this._onUpdate && !n && it(this, 'onUpdate', !0),
                    ((h === o && this._tTime >= this.totalDuration()) ||
                        (!h && a)) &&
                        (T === this._start ||
        ...
        (e.shiftChildren = function (r, n, s) {
            ...
            for (var a = this._first, o = this.labels, f; a; )
                a._start >= s && ((a._start += r), (a._end += r)),
                    (a = a._next);
        ...
        if (
            ...
            if (
                ...
                if (
                    ...
                    (t._startAt._sat = t),
                    e < 0 &&
                        (q ? t._startAt.revert(me) : t._startAt.render(-1, !0)),
                    (t._zTime = e),
                    !a)
                )
                    u(t._startAt, G, G);
            ...
            for (
                ...
                t._op && t._op[w] && t.kill(b, t._op[w]),
                    v &&
                        t._pt &&
                        ((vt = t),
                        E.killTweensOf(b, X, t.globalTime(e)),
                        (U = !t.parent),
                        (vt = 0)),
                    t._pt && o && (Ve[A.id] = 1);
            }
...
var N = (function (u) {
    ...
    return (
            ...
            if (!f) Gr(this, r, n, s);
                ...
                if (((c = l), (v = this.timeline), this._repeat)) {
                    ...
                    p !== m &&
                        ...
                        this.vars.repeatRefresh &&
                            ...
                            this._initted &&
                            ((this._lock = s = 1),
                            (this.render(B(_ * p), !0).invalidate()._lock =
                                0)));
                }
                if (!this._initted) {
                ...
                if (
                    ...
                    !a &&
                        ...
                        !n &&
                        !m &&
                        (it(this, 'onStart'), this._tTime !== l))
                )
                    return this;
                for (d = this._pt; d; ) d.r(x, d.d), (d = d._next);
                (v &&
                    v.render(
                        r < 0 ? r : v._dur * v._ease(c / this._dur),
                        n,
                        s
                    )) ||
                    ...
                    (l === this._tDur || !l) &&
                        ...
                        !n &&
                            ...
                            (it(
                                this,
                                l === o ? 'onComplete' : 'onReverseComplete',
                                !0
                            ),
                            this._prom &&
        ...
        (t.set = function (r, n) {
            return (
                (n.duration = 0), n.repeatDelay || (n.repeat = 0), new t(r, n)
            );
        }),
...
var It = [],
            ...
            (t.kill = function (i, r) {
                ...
                if (
                    (i
                        ? (function () {
                              for (
                                  var a = n.getTweens(), o = n.data.length, f;
                                  o--;
    ...
    we = {
        ...
        defaults: function (t) {
            return (
                t && t.ease && (t.ease = Lt(t.ease, Gt.ease)), yi(Gt, t || {})
            );
        },
        config: function (t) {
            return yi(rt, t || {});
 ...
 */ var Pi,
    ...
    Un = function (t, e, i, r) {
        if (!i || i === 'none') {
            ...
            s && s !== i
                ? ((e = n), (i = s))
                : e === 'borderColor' && (i = ut(t, 'borderTopColor'));
        }
        ...
        if (
            ...
            (r += ''),
            r.substring(0, 6) === 'var(--' &&
                (r = ut(t, r.substring(4, r.indexOf(')')))),
            r === 'auto' &&
                ((_ = t.style[e]),
                (t.style[e] = r),
                (r = ut(t, e) || r),
    ...
    je = function (t, e, i, r, n, s) {
        ...
        i
            ...
            : ((w = kr(t)),
              ...
              (g =
                  w.y +
                  (~(v[1] || v[0]).indexOf('%') ? (g / 100) * w.height : g))),
            r || (r !== !1 && a.smooth)
                ? ((y = T - f),
                  (x = g - h),
        ...
        return (
            ...
            i.svg &&
                (i.uncache
                    ? ((ft = t.getBBox()),
                      (f =
                          i.xOrigin - ft.x + 'px ' + (i.yOrigin - ft.y) + 'px'),
                      (U = ''))
            ...
            P !== _e &&
                ...
                i.svg &&
                    ...
                    (i.forceCSS =
                        t.setAttribute('transform', '') || !Dr(ut(t, z))),
            ...
            (i.x =
                ...
                ((i.xPercent =
                    h &&
                    ((!e && i.xPercent) ||
                        (Math.round(t.offsetWidth / 2) === Math.round(-h)
                            ? -50
                            : 0)))
            ...
            (i.y =
                ...
                ((i.yPercent =
                    l &&
                    ((!e && i.yPercent) ||
                        (Math.round(t.offsetHeight / 2) === Math.round(-l)
                            ? -50
                            : 0)))
            ...
            (i.zOrigin =
                parseFloat(f.split(' ')[2]) || (!e && i.zOrigin) || 0) &&
                (r[H] = Oe(f)),
...
var Rr = {
    ...
    init: function (t, e, i, r, n) {
        ...
        for (_ in e)
            if (
                _ !== 'autoRound' &&
                ((h = e[_]), !(tt[_] && dr(_, e, i, r, t, n)))
            ) {
                if (
                    ((d = typeof h),
                    (p = Pe[_]),
                    d === 'function' &&
                        ((h = h.call(i, r, t, n)), (d = typeof h)),
                    ...
                    if (
                        ...
                        if (
                            ...
                            d === 'string' &&
                                h.substring(0, 6) === 'var(--' &&
                                ((h = ut(t, h.substring(4, h.indexOf(')')))),
                                (l = parseFloat(h))),
                            T ||
                                ((g = t._gsap),
