...
import { C as N } from './chevron-down-BOUXGEku.js';
import { I as h, P as k } from './palette-2omjrnzu.js';
/**
 ...
 */ const G = [
    ...
    I = n('upload', G),
    R = () => {
        const [a, x] = m.useState('text'),
            { farewellPage: E, addElement: l } = j(),
            d = m.useRef(null),
            y = [
                {
                    id: 'text',
                    name: 'Text',
                    icon: e.jsx(F, { className: 'h-5 w-5' }),
                    items: [
                        {
            ...
            f = (t, s) => {
                ...
                const i = {
                    type: s.id === 'text' ? 'text' : t.type || s.id,
                    content: t.content,
                    style: t.style || {},
        ...
        return e.jsxs('div', {
            className:
                'm-4 h-[calc(100vh-2rem)] w-[320px] overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-slate-800/80 to-slate-900/90 backdrop-blur-xl',
            ...
            children: [
                e.jsx('div', {
                    ...
                    children: e.jsxs('h2', {
                        ...
                        children: [
                            e.jsx(M, { className: 'h-5 w-5 text-teal-400' }),
                            e.jsx('span', {
                                className:
                        ...
                        children: y.map((t) => {
                            ...
                            return e.jsxs(
                                c.div,
                                {
                                    ...
                                    children: [
                                        e.jsxs(c.button, {
                                            className: `flex w-full items-center justify-between rounded-lg p-3 text-white ${a === t.id ? 'border border-white/10 bg-gradient-to-r from-teal-500/20 to-blue-500/20' : 'hover:bg-white/5'} transition-all duration-200`,
                                            onClick: () =>
                                                x(a === t.id ? null : t.id),
                                            ...
                                            children: [
                                                e.jsxs('div', {
                                                    ...
                                                    children: [
                                                        e.jsx('div', {
                                                            className: `${a === t.id ? 'text-teal-400' : 'text-slate-400'}`,
                                                            children: t.icon,
                                                        }),
                                                        e.jsx('span', {
                                                            className: `${a === t.id ? 'text-white' : 'text-slate-300'}`,
                                                            children: t.name,
                                                        }),
                                                    ],
                                                }),
                                                e.jsx(N, {
                                                    className: `h-4 w-4 transition-transform duration-300 ${a === t.id ? 'rotate-180 text-teal-400' : 'text-slate-400'}`,
                                                }),
                                            ],
                                        }),
                                        e.jsx(p, {
    ...
    P = () =>
        e.jsx('div', {
            ...
            children: e.jsxs('div', {
                className: 'content flex h-full w-full overflow-hidden',
                children: [
                    e.jsx(R, {}),
                    e.jsx('div', {
                        className: 'w-full',
