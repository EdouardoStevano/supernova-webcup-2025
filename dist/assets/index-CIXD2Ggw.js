...
const d = o.lazy(() =>
        s(() => import('./index-B05oby7z.js'), __vite__mapDeps([0, 1, 2, 3, 4]))
    ),
    i = o.lazy(() =>
        s(() => import('./home-qvlopXV4.js'), __vite__mapDeps([5, 1, 2]))
    ),
    n = o.lazy(() =>
        s(() => import('./profile-Cyto2bIo.js'), __vite__mapDeps([6, 1, 2, 4]))
    ),
    l = o.lazy(() =>
        s(
