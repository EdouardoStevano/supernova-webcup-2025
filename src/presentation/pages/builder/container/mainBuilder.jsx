...
const MainBuilder = () => {
  ...
  const backgrounds = [
    { name: "Dramatic", value: "dramatic-bg", preview: "bg-gradient-to-r from-[#1f1c2c] to-[#928dab]" },
    { name: "Ironic", value: "ironic-bg", preview: "bg-gradient-to-r from-[#fceabb] to-[#f8b500]" },
    { name: "Cringe", value: "cringe-bg", preview: "bg-gradient-to-r from-[#ff4e50] to-[#f9d423]" },
    { name: "Classy", value: "classy-bg", preview: "bg-gradient-to-r from-[#2c3e50] to-[#bdc3c7]" },
    { name: "Absurd", value: "absurd-bg", preview: "bg-gradient-to-r from-[#fc466b] via-[#3f5efb] to-[#00c9ff]" },
  ];
