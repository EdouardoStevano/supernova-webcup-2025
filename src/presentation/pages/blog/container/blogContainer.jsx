...
const BlogContainer = () => {
    ...
    return (
        <div className="flex h-[100vh] w-full overflow-y-auto">
            {/* Audio pour feedback */}
            ...
            >
                ...
                <div
                    style={{ color: '#b5bac1', fontSize: 15, marginBottom: 24 }}
                >
                    <Lottie
                ...
                <div
                    style={{ color: '#5865f2', fontWeight: 600, marginTop: 24 }}
                >
                    # général
                </div>
                        ...
                        style={{
                            ...
                            cursor:
                                newMessage.trim() || newMedia.trim()
                                    ...
                                    : 'not-allowed',
                            opacity:
                                newMessage.trim() || newMedia.trim() ? 1 : 0.7,
                        }}
                        disabled={
                            !(newMessage.trim() || newMedia.trim()) ||
                            toast?.type === 'loading'
