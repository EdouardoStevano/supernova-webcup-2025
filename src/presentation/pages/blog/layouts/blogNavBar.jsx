...
const user = {
  ...
  avatar:
    "https://ui-avatars.com/api/?name=Maher+Ben+Salah&background=ce47bc&color=fff",
    ...
    publications: [
      {
        ...
        likes: 12,
        moodGif: "https://media.giphy.com/media/3o7aD2saalBwwftBIY/giphy.gif",
      },
      {
        id: "abz203",
        title: "Arrêter Twitter : mon expérience",
        likes: 8,
        moodGif: "https://media.giphy.com/media/26ufdipQqU2lhNA4g/giphy.gif",
      },
    ],
  },
  {
    ...
    publications: [
      {
        ...
        likes: 15,
        moodGif: "https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif",
      },
      {
        id: "abz205",
        title: "Supprimer Instagram : libération ou regret ?",
        likes: 22,
        moodGif: "https://media.giphy.com/media/3o6Zt8zb1Pp2v3BzHa/giphy.gif",
      },
    ],
  },
  {
    ...
    publications: [
      {
        ...
        likes: 30,
        moodGif: "https://media.giphy.com/media/3o6Zt6ML6BklcajjsA/giphy.gif",
      },
      {
        id: "abz207",
        title: "Dire adieu à LinkedIn : mon choix",
        likes: 18,
        moodGif: "https://media.giphy.com/media/3o7TKtnuHOHHUjR38Y/giphy.gif",
      },
    ],
  },
  {
    ...
    publications: [
      {
        ...
        likes: 27,
        moodGif: "https://media.giphy.com/media/3o6Zt7xTgY6k5W8lIc/giphy.gif",
      },
      {
        id: "abz209",
        title: "Quitter WhatsApp : retour à la vraie vie",
        likes: 14,
        moodGif: "https://media.giphy.com/media/3o7TKzQY6p2dQw1lsk/giphy.gif",
      },
    ],
  },
  {
    ...
    publications: [
      {
        ...
        likes: 25,
        moodGif: "https://media.giphy.com/media/3o6Zt481isNVuQI1l6/giphy.gif",
      },
      {
        id: "abz213",
    ...
    <div style={{ display: "flex", height: "100vh" }}>
        ...
        <div>
          ...
          {navItems.map((item, idx) => (
            ...
            >
              <button
                style={{
                  background: hovered === idx ? "#ce47bc" : "none",
                  border: "none",
                  outline: "none",
                  width: 48,
                  height: 48,
                  ...
                  boxShadow: hovered === idx ? "0 4px 16px #ce47bc44" : "none",
      ...
      >
        ...
        <div style={{ marginTop: 32 }}>
          <h3 style={{ color: "#ce47bc", fontSize: 16, marginBottom: 8 }}>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
            {personalPages.map((page, idx) => (
              <div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "rgba(206,71,188,0.18)";
                  e.currentTarget.style.borderLeft = `6px solid ${page.color}`;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "rgba(206,71,188,0.08)";
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ color: "#b9bbbe", fontSize: 13 }}>{user.email}</div>
          </div>
        </div>
      </aside>
    </div>
