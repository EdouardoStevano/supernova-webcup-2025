...
Command: npx gltfjsx@6.5.3 3_seconds_of_vacations.glb 
...
export function ModelsVacc(props) {
    const group = React.useRef();
    const { nodes, materials, animations } = useGLTF(
        '/3_seconds_of_vacations.glb'
    );
    const { actions } = useAnimations(animations, group);
    useEffect(() => {
        console.log('actions', actions); // Vérifiez les noms disponibles ici
        if (actions['Take 01']) {
                    ...
                    <group name="Root">
                        ...
                        >
                            <mesh
                                ...
                                morphTargetDictionary={
                                    nodes.Plane029_0.morphTargetDictionary
                                }
                                morphTargetInfluences={
                                    nodes.Plane029_0.morphTargetInfluences
                                }
                            />
                        </group>
                        ...
                        >
                            <mesh
                                ...
                                material={materials.Material}
                                morphTargetDictionary={
                                    nodes.Sphere_0.morphTargetDictionary
                                }
                                morphTargetInfluences={
                                    nodes.Sphere_0.morphTargetInfluences
                                }
                            />
                        </group>
                        <group
                        ...
                        >
                            <mesh
                                ...
                                material={materials.Material}
                                morphTargetDictionary={
                                    nodes.Circle_0.morphTargetDictionary
                                }
                                morphTargetInfluences={
                                    nodes.Circle_0.morphTargetInfluences
                                }
                            />
                        </group>
                        <group
                        ...
                        >
                            <mesh
                                ...
                                material={materials.Material}
                                morphTargetDictionary={
                                    nodes.tree_0.morphTargetDictionary
                                }
                                morphTargetInfluences={
                                    nodes.tree_0.morphTargetInfluences
                                }
                            />
                        </group>
                        <group
                            name="Plane010"
                            position={[0.247, -1.112, 0.087]}
                        >
                            <mesh
                                name="Plane010_0"
                        ...
                        >
                            <mesh
                                ...
                                material={materials.Material}
                                morphTargetDictionary={
                                    nodes.Mball003_0.morphTargetDictionary
                                }
                                morphTargetInfluences={
                                    nodes.Mball003_0.morphTargetInfluences
                                }
                            />
                        </group>
                        <group
                            name="Circle004"
                            position={[-0.362, -0.496, 0.142]}
                        >
                            <mesh
                                name="Circle004_0"
                        ...
                        <group name="Plane021" position={[0.004, 0.677, 0.049]}>
                            <mesh
                                ...
                                material={materials.Material}
                                morphTargetDictionary={
                                    nodes.Plane021_0.morphTargetDictionary
                                }
                                morphTargetInfluences={
                                    nodes.Plane021_0.morphTargetInfluences
                                }
                            />
                        </group>
                        <group
