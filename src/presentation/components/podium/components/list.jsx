            ...
            <AnimatePresence>
                {data.map((player, index) => {
                    ...
                    const positionChange =
                        prevIndex !== undefined ? prevIndex - index : 0;
                    ...
                    return (
                        <motion.div
                            ...
                            className="mb-2 flex items-center justify-between rounded-lg border border-dotted border-gray-500 bg-white px-4 py-2"
                        >
