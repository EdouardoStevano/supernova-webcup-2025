...
import { useCursor, MeshPortalMaterial, CameraControls, Gltf, Text, Preload, Environment } from '@react-three/drei'
...
export const CapsuleTemporal = ({ items }) => {
  ...
  return (
    ...
    <Environment preset='sunset' />
      ...
      {/* Objets */}
      {items.map(({ id, name, author, bg, width, height, modelSrc, modelScale, modelPosition }, index) => {
    ...
    <group position={position} rotation={rotation}>
      ...
      >
        ...
        <MeshPortalMaterial ref={portal} events={params?.id === id} side={THREE.DoubleSide}>
          ...
          <Gltf src={modelSrc} scale={modelScale} position={modelPosition} />
        </MeshPortalMaterial>
      </mesh>
    </group>
  )
